...
*Authors:* https://github.com/jonasgwozdz[Jonas Gwozdz], https://github.com/anbo-de[Andreas Both] — https://www.htwk-leipzig.de/en/htwk-leipzig[Leipzig University of Applied Sciences (HTWK Leipzig)] / https://wse-research.org/#[WSE Research]
...
@inproceedings{gwozdz2026bea,
  ...
  booktitle={Proceedings of the 21th Workshop on Innovative Use of NLP for Building Educational Applications (BEA 2025)},
