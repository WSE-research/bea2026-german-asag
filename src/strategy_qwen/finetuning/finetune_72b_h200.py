"""72B fine-tune on H200: QLoRA (4-bit NF4) + LoRA r=32, all data, 3 epochs.

Matches the successful 32B-alldata config but at 72B scale.
H200 NVL has 150 GB VRAM — 4-bit model uses ~40 GB, leaving ~110 GB for training.
"""
...
def main():
    print("=" * 60)
    print("72B H200 FINE-TUNE — QLoRA NF4 + LoRA r=32, ALL DATA, 3 EPOCHS")
    print("=" * 60)
