"""Train 32B on ALL data (train+trial=7899) for the submission model."""
...
OUTPUT_DIR = PROJECT_ROOT / "models" / "qwen25-32b-lora-alldata"
...
def main():
    ...
    print("Training 32B on ALL data: rank=32, epochs=3, lr=2e-4")
    start = time.time()
    trainer.train()
    ...
    print("SUBMISSION MODEL checkpoint:", checkpoints[-1] if checkpoints else "NONE")
