"""
Strategy A: Rubric-Only Scoring
Usage:
    python -m src.strategy_a_rubric_only.run [--split train|trial] [--workers 5] [--limit N]
"""
...
from src.strategy_a_rubric_only.scorer import score_sample


def main():
    parser = argparse.ArgumentParser(description="Strategy A: Rubric-Only Scoring")
    ...
    # Output paths
    output_dir = Path("results/strategy_a")
    ...
    if y_true:
        ...
        print_evaluation_report(metrics, title="Strategy A: Rubric-Only")
