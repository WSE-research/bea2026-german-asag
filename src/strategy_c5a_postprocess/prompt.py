"""
Prompt construction for Strategy C5a: Post-Processing + Anti-Examples.

Extends C4's prompt (which is identical to C2's) with an ANTI-BEISPIELE section
that shows the model common scoring mistakes to avoid.
"""
...
def build_system_prompt() -> str:
    return (
        ...
        "\n"
        "ANTI-BEISPIELE — Häufige Bewertungsfehler, die du NICHT machen darfst:\n"
        "\n"
        "ANTI-BEISPIEL 1 — Häufiger Fehler: Incorrect als Partially correct bewertet\n"
        'Schülerantwort: "Man kann drei Sättigungskurven mit unterschiedlichen Steigungen erkennen."\n'
        "Falsche Bewertung: Partially correct\n"
        "RICHTIGE Bewertung: Incorrect\n"
        "Grund: Die Antwort beschreibt nur, was im Diagramm sichtbar ist, ohne fachliche "
        "Konzepte aus der Rubrik zu nennen. Bloße Beobachtungen ohne Erklärung = Incorrect.\n"
        "\n"
        "ANTI-BEISPIEL 2 — Häufiger Fehler: Incorrect als Partially correct bewertet\n"
        'Schülerantwort: "Kälte"\n'
        "Falsche Bewertung: Partially correct\n"
        "RICHTIGE Bewertung: Incorrect\n"
        "Grund: Ein einzelnes Wort ohne Erklärung oder Bezug zur Rubrik erfüllt KEINEN "
        "fachlichen Kernpunkt.\n"
        "\n"
        "FORMAT\n"
