"""
Strategy C2: Tuned Few-Shot Scoring

Improved prompt targeting Incorrect->Partially correct over-prediction.

Usage:
    python -m src.strategy_c2_fewshot_tuned.run [--split train|trial] [--workers 5] [--limit N] [--examples-per-label 2] [--seed 42] [--offset N]
"""
...
RESULTS_DIR = PROJECT_ROOT / "results" / "strategy_c2"
...
def main():
    ...
    print("=" * 70)
    print("  Strategy C2: Tuned Few-Shot Scoring")
    print("=" * 70)
    ...
    meta = {"strategy": "C2: Tuned Few-Shot", "split": args.split, "model": get_model(),
