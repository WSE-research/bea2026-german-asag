"""
Prompt construction for Strategy C2: Tuned Few-Shot.

Improved from Strategy C based on batch 1 error analysis:
- #1 error: Incorrect -> Partially correct (model too lenient)
- #2 error: Correct -> Partially correct (model too cautious)
- Fix: Tighten "Partially correct" definition with explicit boundary rules
"""
