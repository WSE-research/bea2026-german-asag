"""
Scorer for Strategy C2: Tuned Few-Shot.

Same architecture as Strategy C but with improved prompt targeting
the Incorrect->Partially correct over-prediction issue.
"""
...
from src.strategy_c2_fewshot_tuned.prompt import (
    build_system_prompt,
    build_user_prompt,
    parse_response,
)
