"""
Strategy C6b: Claude-Optimized Prompt + Adaptive Difficulty + Metadata Logging

Redesigned prompt following Anthropic's prompting best practices:
- XML tags for structure (<question>, <rubric>, <examples>, <student_answer>)
- English system prompt with German content
- Explicit JSON-only output instructions
- Example tags for few-shot calibration

Usage:
    OPENROUTER_MODEL=anthropic/claude-sonnet-4.6 python -m src.strategy_c6b_claude_tuned.run --split trial --limit 20 --workers 2 --seed 42
"""
...
from src.strategy_c6b_claude_tuned.scorer import configure, score_sample, get_difficulty

PROJECT_ROOT = Path(__file__).resolve().parent.parent.parent
RESULTS_DIR = PROJECT_ROOT / "results" / "strategy_c6b"
...
def main():
    ...
    model = get_model()
    print("=" * 70)
    print("  Strategy C6b: Claude-Optimized Prompt + Adaptive Difficulty")
    print("=" * 70)
    ...
    meta = {
        "strategy": "C6b: Claude-Optimized Prompt + Adaptive Difficulty",
